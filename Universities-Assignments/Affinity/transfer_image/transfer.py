...
result = np.zeros((int(h*1.11), int(w*1.08), 3), dtype=np.uint8)

kernel = np.array([[1 , 0 , 100],
                   [0 , 1 , 100],
                   [0 , 0 , 1]])
...
cv2.imwrite("Univercities-Assignments/Affinity\outputs/transfered-image2.jpg" , result)